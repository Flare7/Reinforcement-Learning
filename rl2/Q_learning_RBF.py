...
class FeatureTransformer:
  def __init__(self, env, n_components=500):
    ...
    # since we dont actually know what scale is good or perhaps multiple scales are good 
    # we are going to use multiple RBF kernels with different scales at the same time
    # multiple fearture verctors -> one big feature vector 
...
class Model:
  def __init__(self, env, feature_transformer, learning_rate):
    ...
    for i in range(env.action_space.n):
      ...
      #This allows us to do one step of gradient descent only what we want
...
def main(show_plots=True):
  ...
  monitor_dir = os.getcwd() + "\\" + filename 
