  ...
  for it in range(20000):
    ...
    for s, G in states_and_returns:
      ...
      if s not in seen_states:
        ...
        #X parameter needs to store as np.array to be used in prediction as polynomial function (model)
        x = s2x(s)
        #dot() is multiplication of matrix X, similar to multiplication in matrix in math as we do with respect of theta
        V_hat = theta.dot(x)
