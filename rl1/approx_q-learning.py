...
from grid_world import standard_grid, negative_grid, grid_5x5
...
class Model:
  def __init__(self):
    #number in parenthesis states the number of states that can be reached 
    #It will make list of numbers, numpy array (<class 'numpy.ndarray'>)
    #Number has to be similar 
